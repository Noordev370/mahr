...
import Html.Attributes exposing (class, for, id, name, required, src, style, type_)
...
view : Model -> Html Msg
view model =
    div [] [ usernameInput, passwordInput, passwordConfirmInput, profilePictureInput, profilePicturePreview model, submitButton ]
...
-- defualt pricture to show and send to server if the user didn't
-- upload a picture. Base 64 format
